    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="vector_representation",
                        to="catalog_service.book",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["book", "interaction_type"],
                        name="recommendat_book_id_2cf52a_idx",
                    ),
                    models.Index(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "unique_together": {("book", "trend_type", "period_start")},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["book_a", "overall_similarity"],
                        name="recommendat_book_a__575bb2_idx",
                    ),
                    models.Index(
                        fields=["book_b", "overall_similarity"],
                        name="recommendat_book_b__1a3d27_idx",
                    ),
                    models.Index(
        ...
        migrations.AlterUniqueTogether(
            name="recommendation",
            unique_together={("recommendation_set", "book")},
        ),
        migrations.AddIndex(
            model_name="bookvector",
            index=models.Index(
                fields=["popularity_score"], name="recommendat_popular_e76432_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bookvector",
